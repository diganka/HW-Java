        ...
        public void returnCost(String productName, double productCost, Seller seller, Buyer buyer) {
            ...
            if (productName.toLowerCase().contains("алкоголь") && buyer.getAge() < 18) {
                if (seller.honest()) {
                    ...
                    System.out.println("Продажа алкоголя разрешена несовершеннолетним");
                }
            }

            System.out.println(" Уважаемый " + buyer.getName() + ", продавец " + seller.getName() + " нашего магазина " +
                    "\"" +
                    name + "\", продаст вам этот товар " + productName +
                    ",\n у них есть алкогольная продукция, а Ваш возраст " + buyer.getAge() + ". \n Стоимость вашей покупки равна " + сost + " грн.");
            System.out.println(" Вот Вам скидка в размере 10 %.");
        }
}
